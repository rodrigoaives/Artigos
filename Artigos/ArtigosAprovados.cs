...
namespace Artigos
{
    public partial class ArtigosAprovados : Form
    {
        public string ArtigoSelecionado = "";
        public ArtigosAprovados()
        {
            InitializeComponent();
        }

        private void ArtigosAprovados_Load(object sender, EventArgs e)
        {
            var conn = Login.ConnectOpen;
            string sql = "Select * from artigos where status = 'Aprovado'";
